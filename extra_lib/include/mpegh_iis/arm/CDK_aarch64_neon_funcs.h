/***************************  Fraunhofer IIS CDK Tools  **********************
                        ...
                        (C) Copyright Fraunhofer IIS (2017)
                               All Rights Reserved
...
#ifndef CDK_AARCH64_NEON_FUNCS_H
#define CDK_AARCH64_NEON_FUNCS_H
...
/* Example: LDR X0, [X1, #8]                                                                */
#define A64_ldr_Xt_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_Wt_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_Qt_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_Dt_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_St_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_Ht_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldr_Bt_I(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldp_Xt_I(  dst1, dst2, src, offset)   " LDP  " #dst1 ", " #dst2 ", [" #src ", # " #offset "]\n\t"
#define A64_ldpsw_Xt_I(dst1, dst2, src, offset)   LDPSW dst1, dst2, [src, CDK_TEXT(hash) offset]
#define A64_ldp_Wt_I(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]
#define A64_ldp_Qt_I(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]
#define A64_ldp_Dt_I(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]
#define A64_ldp_St_I(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]
#define A64_ldrb_Wt_I( dst1,       src, offset)   LDRB  dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrh_Wt_I( dst1,       src, offset)   LDRH  dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrsb_Xt_I(dst1,       src, offset)   LDRSB dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrsb_Wt_I(dst1,       src, offset)   LDRSB dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrsh_Xt_I(dst1,       src, offset)   LDRSH dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrsh_Wt_I(dst1,       src, offset)   LDRSH dst1,       [src, CDK_TEXT(hash) offset]
#define A64_ldrsw_Xt_I(dst1,       src, offset)   LDRSW dst1,       [src, CDK_TEXT(hash) offset]

#define A64_str_Xt_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_Wt_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_Qt_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_Dt_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_St_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_Ht_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_str_Bt_I(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]
#define A64_stp_Xt_I(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]
#define A64_stp_Wt_I(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]
#define A64_stp_Qt_I(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]
#define A64_stp_Dt_I(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]
#define A64_stp_St_I(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]
#define A64_strb_Wt_I( src1,       dst, offset)   STRB  src1,       [dst, CDK_TEXT(hash) offset]
#define A64_strh_Wt_I( src1,       dst, offset)   STRH  src1,       [dst, CDK_TEXT(hash) offset]
...
#define A64_ldpsw_Xt_X_LSL(dst1, dst2, src, offset, lsl)   LDPSW dst1, dst2, [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldp_Wt_X_LSL(  dst1, dst2, src, offset, lsl)   LDP   dst1, dst2, [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldp_Qt_X_LSL(  dst1, dst2, src, offset, lsl)   LDP   dst1, dst2, [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldp_Dt_X_LSL(  dst1, dst2, src, offset, lsl)   LDP   dst1, dst2, [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldp_St_X_LSL(  dst1, dst2, src, offset, lsl)   LDP   dst1, dst2, [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrb_Wt_X_LSL( dst1,       src, offset, lsl)   LDRB  dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrh_Wt_X_LSL( dst1,       src, offset, lsl)   LDRH  dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrsb_Xt_X_LSL(dst1,       src, offset, lsl)   LDRSB dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrsb_Wt_X_LSL(dst1,       src, offset, lsl)   LDRSB dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrsh_Xt_X_LSL(dst1,       src, offset, lsl)   LDRSH dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrsh_Wt_X_LSL(dst1,       src, offset, lsl)   LDRSH dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
#define A64_ldrsw_Xt_X_LSL(dst1,       src, offset, lsl)   LDRSW dst1,       [src, offset, LSL, CDK_TEXT(hash) lsl]
...
#define A64_ldr_Xt_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_Wt_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_Qt_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_Dt_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_St_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_Ht_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldr_Bt_X_SXTW_LSL(  dst1,       src, sxtw, lsl)   LDR   dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldp_Xt_X_SXTW_LSL(  dst1, dst2, src, sxtw, lsl)   LDP   dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldpsw_Xt_X_SXTW_LSL(dst1, dst2, src, sxtw, lsl)   LDPSW dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldp_Wt_X_SXTW_LSL(  dst1, dst2, src, sxtw, lsl)   LDP   dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldp_Qt_X_SXTW_LSL(  dst1, dst2, src, sxtw, lsl)   LDP   dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldp_Dt_X_SXTW_LSL(  dst1, dst2, src, sxtw, lsl)   LDP   dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldp_St_X_SXTW_LSL(  dst1, dst2, src, sxtw, lsl)   LDP   dst1, dst2, [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrb_Wt_X_SXTW_LSL( dst1,       src, sxtw, lsl)   LDRB  dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrh_Wt_X_SXTW_LSL( dst1,       src, sxtw, lsl)   LDRH  dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrsb_Xt_X_SXTW_LSL(dst1,       src, sxtw, lsl)   LDRSB dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrsb_Wt_X_SXTW_LSL(dst1,       src, sxtw, lsl)   LDRSB dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrsh_Xt_X_SXTW_LSL(dst1,       src, sxtw, lsl)   LDRSH dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrsh_Wt_X_SXTW_LSL(dst1,       src, sxtw, lsl)   LDRSH dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_ldrsw_Xt_X_SXTW_LSL(dst1,       src, sxtw, lsl)   LDRSW dst1,       [src, sxtw, SXTW, CDK_TEXT(hash) lsl]

#define A64_str_Xt_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_Wt_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_Qt_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_Dt_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_St_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_Ht_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_str_Bt_X_SXTW_LSL(  src1,       dst, sxtw, lsl)   STR   src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_stp_Xt_X_SXTW_LSL(  src1, src2, dst, sxtw, lsl)   STP   src1, src2, [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_stp_Wt_X_SXTW_LSL(  src1, src2, dst, sxtw, lsl)   STP   src1, src2, [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_stp_Qt_X_SXTW_LSL(  src1, src2, dst, sxtw, lsl)   STP   src1, src2, [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_stp_Dt_X_SXTW_LSL(  src1, src2, dst, sxtw, lsl)   STP   src1, src2, [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_stp_St_X_SXTW_LSL(  src1, src2, dst, sxtw, lsl)   STP   src1, src2, [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_strb_Wt_X_SXTW_LSL( src1,       dst, sxtw, lsl)   STRB  src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
#define A64_strh_Wt_X_SXTW_LSL( src1,       dst, sxtw, lsl)   STRH  src1,       [dst, sxtw, SXTW, CDK_TEXT(hash) lsl]
...
/* Example: LDR X0, [X1, #8]! */
#define A64_ldr_Xt_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldr_Wt_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldr_Qt_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldr_St_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldr_Ht_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldr_Bt_IB(  dst1,       src, offset)   LDR   dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldp_Xt_IB(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldpsw_Xt_IB(dst1, dst2, src, offset)   LDPSW dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldp_Wt_IB(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldp_Qt_IB(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldp_Dt_IB(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldp_St_IB(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src, CDK_TEXT(hash) offset]!
#define A64_ldrb_Wt_IB( dst1,       src, offset)   LDRB  dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrh_Wt_IB( dst1,       src, offset)   LDRH  dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrsb_Xt_IB(dst1,       src, offset)   LDRSB dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrsb_Wt_IB(dst1,       src, offset)   LDRSB dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrsh_Xt_IB(dst1,       src, offset)   LDRSH dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrsh_Wt_IB(dst1,       src, offset)   LDRSH dst1,       [src, CDK_TEXT(hash) offset]!
#define A64_ldrsw_Xt_IB(dst1,       src, offset)   LDRSW dst1,       [src, CDK_TEXT(hash) offset]!

#define A64_str_Xt_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_Wt_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_Qt_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_Dt_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_St_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_Ht_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_str_Bt_IB(  src1,       dst, offset)   STR   src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_stp_Xt_IB(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]!
#define A64_stp_Wt_IB(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]!
#define A64_stp_Qt_IB(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]!
#define A64_stp_Dt_IB(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]!
#define A64_stp_St_IB(  src1, src2, dst, offset)   STP   src1, src2, [dst, CDK_TEXT(hash) offset]!
#define A64_strb_Wt_IB( src1,       dst, offset)   STRB  src1,       [dst, CDK_TEXT(hash) offset]!
#define A64_strh_Wt_IB( src1,       dst, offset)   STRH  src1,       [dst, CDK_TEXT(hash) offset]!

/* Post-index: Load/store first from/to source/destination pointer, then update pointer with immediate offset */
/* Example: LDR X0, [X1] #8 */
#define A64_ldr_Xt_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldr_Wt_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldr_Qt_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldr_St_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldr_Ht_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldr_Bt_IA(  dst1,       src, offset)   LDR   dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldp_Xt_IA(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldpsw_Xt_IA(dst1, dst2, src, offset)   LDPSW dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldp_Wt_IA(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldp_Qt_IA(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldp_Dt_IA(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldp_St_IA(  dst1, dst2, src, offset)   LDP   dst1, dst2, [src], CDK_TEXT(hash) offset
#define A64_ldrb_Wt_IA( dst1,       src, offset)   LDRB  dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrh_Wt_IA( dst1,       src, offset)   LDRH  dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrsb_Xt_IA(dst1,       src, offset)   LDRSB dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrsb_Wt_IA(dst1,       src, offset)   LDRSB dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrsh_Xt_IA(dst1,       src, offset)   LDRSH dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrsh_Wt_IA(dst1,       src, offset)   LDRSH dst1,       [src], CDK_TEXT(hash) offset
#define A64_ldrsw_Xt_IA(dst1,       src, offset)   LDRSW dst1,       [src], CDK_TEXT(hash) offset
...
{
    CDK_ASSERT((size == 128) || (size == 64));
    CDK_ASSERT((width == 64) || (width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 1*(size>>3)));
    switch (width)
    {
      case 64:
      {
...
{
    CDK_ASSERT((size == 128) || (size == 64));
    CDK_ASSERT((width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 2*(size>>3)));
    switch (width)
    {
...
static void __A64_ld1rx1_IA(INT width, INT size, INT64 &dst1, INT64 &src, INT64 imm)
{
    ...
    CDK_ASSERT((width == 64) || (width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 1*(width>>3)));
    switch (width)
    {
      case 64:
      {
...
static void __A64_ld1rx2_IA(INT width, INT size, INT64 &dst1, INT64 &dst2, INT64 &src, INT64 imm)
{
    ...
    CDK_ASSERT((width == 64) || (width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 2*(width>>3)));
    switch (width)
    {
      case 64:
      {
...
static void __A64_ld1rx3_IA(INT width, INT size, INT64 &dst1, INT64 &dst2, INT64 &dst3, INT64 &src, INT64 imm)
{
    ...
    CDK_ASSERT((width == 64) || (width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 3*(width>>3)));
    switch (width)
    {
      case 64:
      {
...
static void __A64_ld1rx4_IA(INT width, INT size, INT64 &dst1, INT64 &dst2, INT64 &dst3, INT64 &dst4, INT64 &src, INT64 imm)
{
    ...
    CDK_ASSERT((width == 64) || (width == 32) || (width == 16) || (width == 8));
    INT i, num = size / width;
    CDK_ASSERT((imm == 0) || (imm == 4*(width>>3)));
    switch (width)
    {
      case 64:
      {
...
static void __A64_ld1_lane_IA(INT width, INT64 &dst1, INT lane, INT64 &src, INT64 imm)
{
    ...
    switch (width)
    {
      case 32:
      {
        INT *Src  = (INT *) src;
        INT *Dst1 = (INT *) dst1;
        CDK_ASSERT((lane >=0) && (lane <= 3));
        // CDK_ASSERT((imm == 0) || (imm == 1*4));
        Dst1[lane] = Src[0];
      }
        break;
      case 16:
      {
        SHORT *Src  = (SHORT *) src;
        SHORT *Dst1 = (SHORT *) dst1;
        CDK_ASSERT((lane >=0) && (lane <= 7));
        // CDK_ASSERT((imm == 0) || (imm == 1*2));
        Dst1[lane] = Src[0];
      }
        break;
      case 8:
      {
        SCHAR *Src  = (SCHAR *) src;
        SCHAR *Dst1 = (SCHAR *) dst1;
        CDK_ASSERT((lane >=0) && (lane <= 15));
        // CDK_ASSERT((imm == 0) || (imm == 1*1));
        Dst1[lane] = Src[0];
      }
        break;
    }
...
void A64_check_move_immediate_sp(float immediate)
{
   ...
   {
     /*  Mantissa exceeds */
     CDKprintf("Error in float immediate mantissa: %f = %f *2^%d\n", immediate, imm, exponent);
   }
   else if ( (exponent > 0) || (exponent < -7) )
   {
     /* Exponent exceeds */
     CDKprintf("Error in float immediate exponent: %f = %f *2^%d\n", immediate, imm, exponent);
   }
   else
     CDKprintf("Success in float immediate check: %f = %f *2^%d\n", immediate, imm, exponent);
}
...
void A64_check_move_immediate(int size, int datatype, int sign, INT64 immediate)
{
  ...
  if (immediate)
  {
    ...
    {
      if (sign == -1)
        CDKprintf ("Error in MVN instruction: I8 datatype not available\n");
    ...
    else if (datatype == 16)
    {
      ...
      else
      {
        ...
        {
          CDKprintf ("Error in 16-bit immediate: 0x%016X - one of the lower 2 bytes must be 0x00\n", immediate);
        }
        else if ((sign == -1) && !( (byte0 == 0xFF) || (byte1 == 0xFF) ))
        {
          CDKprintf ("Error in 16-bit immediate: 0x%016X - one of the lower 2 bytes must be 0xFF\n", immediate);
        }
      }
    }
    else if (datatype == 32)
    {
      ...
      {
        CDKprintf ("Error in 32-bit immediate: 0x%016X - upper 4 bytes must be 0x00\n", immediate);
      }
      else if ( (sign == -1) && !( ((byte4 & byte5 & byte6 & byte7) != 0xFF) || ((byte4 | byte5 | byte6 | byte7) != 0x00)) )
      {
        CDKprintf ("Error in 32-bit immediate: 0x%016X - upper 4 bytes must be 0xFF/0x00\n", immediate);
      }
      if (sign == 1)
      {
      ...
      else
      {
        ...
        {
          CDKprintf ("Error in 32-bit immediate: 0x%016X - upper fillbytes must be 0xFF, lower fillbytes must be 0xFF/0x00\n", immediate);
        }
      }
    }
    else if (datatype == 64)
    {
      if (sign == -1)
        CDKprintf ("Error in MVN instruction: I64 datatype not available\n");
...
#define A64_mov_Xt(dst, src)                     "MOV " #dst ", " #src "\n\t"
#define A64_mov_Wt(dst, src)                     "MOV " #dst ", " #src "\n\t"
...
#define A64_movi(    width, size, dst, imm)       __A64_movi_lsl((INT) width, (INT) size, (INT64 &) dst, (UINT64) imm, (INT) 0);
...
static inline void __A64_mvni_i32_lsl(int size, A64_S *dst, INT64 imm, int lsl)
{
    ...
    if ((lsl == 0) || (lsl == 8) || (lsl == 16) || (lsl == 24))
    {
      for (int i = 0; i < (size >> 5); i++)
      {
       ...
       CDKprintf ("Error in MVNI instruction: LSL operand (%d) must be in range [0,8,16,24]\n", lsl);
}
static inline void __A64_mvni_i32_msl(int size, A64_S *dst, INT64 imm, int msl)
{
    ...
    if ((msl == 8) || (msl == 16))
    {
      ...
      for (int i = 0; i < (size >> 5); i++)
      {
       ...
       CDKprintf ("Error in MVNI instruction: MSL operand (%d) must be in range [8,16]\n", msl);
}
...
static inline void __A64_movi_lsl(INT width, INT size, INT64 &dst, UINT64 imm, INT lsl)
{
    ...
    CDK_ASSERT((width == 8) || (width == 16) || (width == 32) || (width == 64));
    CDK_ASSERT((size == 64) || (size == 128) );
    ...
    switch (width)
    {
      ...
      {
        CDK_ASSERT((lsl == 0) || (lsl == 8) || (lsl == 16) || (lsl == 24));
        UINT *Dst = (UINT *) dst;
        A64_check_move_immediate(64, 8, 1, imm);
        for (i = 0; i < num; i++)
        {
...
#if defined(__CC_ARM)
/* reference: ARM Cortex-A Series Version 1.0 Programmer's Guide for ARMv8-A */
/* chapter 6.3.4  Specify the address for a Load or Store instruction, table 6-8 Offset addressing modes */
/* load/store from/to the address in src/dst without pointer modification */
/* Example: LDR X0, [X1]                                                  */
#else
/* ARMv8 GCC */
#endif
...
static void inline CDK_vneg_s32_q (A64_V dst, A64_V src)
{
  A64_S* Dst = (A64_S*) dst;
  A64_S* Src = (A64_S*) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vneg_s32_d (A64_X dst, A64_X src)
{
  A64_S *Dst = (A64_S*) dst;
  A64_S *Src = (A64_S*) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vneg_s16_q (A64_V dst, A64_V src)
{
  A64_H *Dst = (A64_H*) dst;
  A64_H *Src = (A64_H*) src;
  for(int i = 0; i < 4; i++)
  {
    CDK_check_s16_overflow((A64_S) -Src[i]);
    Dst[i] = -Src[i];
  }
}
static void inline CDK_vneg_s16_d (A64_X dst, A64_X src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vqneg_s32_q (A64_V dst, A64_V src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vqneg_s32_d (A64_X dst, A64_X src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vqneg_s16_q (A64_V dst, A64_V src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vqneg_s16_d (A64_X dst, A64_X src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vabs_s32_q(A64_V dst, A64_V src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vabs_s32_d(A64_X dst, A64_X src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vabs_s16_q(A64_V dst, A64_V src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 8; i++)
...
static void inline CDK_vabs_s16_d(A64_X dst, A64_X src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vqabs_s32_q(A64_V dst, A64_V src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S*) src;
  for(int i = 0; i < 4; i++)
...
static void inline CDK_vqabs_s32_d(A64_X dst, A64_X src)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for(int i = 0; i < 2; i++)
...
static void inline CDK_vqabs_s16_q(A64_V dst, A64_V src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 8; i++)
...
static void inline CDK_vqabs_s16_d(A64_X dst, A64_X src)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for(int i = 0; i < 4; i++)
...
static A64_S CDK_sat_shl_s32(A64_S val, INT immediate)
{
  CDK_ASSERT(immediate >= 0);
...
static A64_H CDK_sat_shl_s16(A64_H val, INT immediate)
{
  CDK_ASSERT(immediate >= 0);
...
static A64_S CDK_sat_add_s32(A64_S val1, A64_S val2)
{
...
static A64_S CDK_sat_sub_s32(A64_S val1, A64_S val2)
{
  A64_S retval = val1 - val2;
  if ((val1 ^ val2) < 0)
  {
...
{
    CDK_ASSERT((width == 32) || (width == 16) || (width == 8));
    CDK_ASSERT((size == 128) || (width == 64) || (width == 8));
...
#endif
#else
#define CDK_vqshl_s32(size, dst, src1, src2)           { if (size == 128) { CDK_vqshl_q_s32((A64_V) dst, (A64_V) src1, (A64_V) src2); }   else if (size == 64) { CDK_vqshl_d_s32((A64_X) dst, (A64_X) src1, (A64_X) src2); } }
#define CDK_vqshl_s32_imm(size, dst, src, immediate)   { if (size == 128) { CDK_vqshl_q_s32_imm((A64_V) dst, (A64_V) src, immediate); }    else if (size == 64) { CDK_vqshl_d_s32_imm((A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vqshl_s16(size, dst, src1, src2)           { if (size == 128) { CDK_vqshl_q_s16((A64_V) dst, (A64_V) src1, (A64_V) src2); }   else if (size == 64) { CDK_vqshl_d_s16((A64_X) dst, (A64_X) src1, (A64_X) src2); } }
#define CDK_vqshl_s16_imm(size, dst, src, immediate)   { if (size == 128) { CDK_vqshl_q_s16_imm((A64_V) dst, (A64_V) src, immediate); }    else if (size == 64) { CDK_vqshl_d_s16_imm((A64_X) dst, (A64_X) src, immediate); } }

static void inline CDK_vqshl_q_s32(A64_V dst, A64_V src1, A64_V src2)
{
  A64_S *Dst  = (A64_S *) dst;
...
static void inline CDK_vqshl_d_s32(A64_X dst, A64_X src1, A64_X src2)
{
  A64_S *Dst  = (A64_S *) dst;
  A64_S *Src1 = (A64_S *) src1;
  A64_S *Src2 = (A64_S *) src2;
...
static void inline CDK_vqshl_q_s32_imm (A64_V dst, A64_V src, INT immediate)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for (int i = 0; i < 4; i++)
...
static void inline CDK_vqshl_d_s32_imm (A64_X dst, A64_X src, INT immediate)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  for (int i = 0; i < 2; i++)
...
static void inline CDK_vqshl_q_s16(A64_V dst, A64_V src1, A64_V src2)
{
  A64_H *Dst  = (A64_H *) dst;
...
static void inline CDK_vqshl_d_s16(A64_X dst, A64_X src1, A64_X src2)
{
  A64_H *Dst  = (A64_H *) dst;
  A64_H *Src1 = (A64_H *) src1;
  A64_H *Src2 = (A64_H *) src2;
...
static void inline CDK_vqshl_q_s16_imm (A64_V dst, A64_V src, INT immediate)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for (int i = 0; i < 4; i++)
...
static void inline CDK_vqshl_d_s16_imm (A64_X dst, A64_X src, INT immediate)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  for (int i = 0; i < 2; i++)
...
#endif
#else
#define CDK_vsri_8( size, dst, src, immediate)   { if (size == 128) { CDK_vsri_q(8, (A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsri_d(8, (A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsri_16(size, dst, src, immediate)   { if (size == 128) { CDK_vsri_q(16,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsri_d(16,(A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsri_32(size, dst, src, immediate)   { if (size == 128) { CDK_vsri_q(32,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsri_d(32,(A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsri_64(size, dst, src, immediate)   { if (size == 128) { CDK_vsri_q(64,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsri_d(64,(A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsli_8( size, dst, src, immediate)   { if (size == 128) { CDK_vsli_q(8, (A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsli_d(8, (A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsli_16(size, dst, src, immediate)   { if (size == 128) { CDK_vsli_q(16,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsli_d(16,(A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsli_32(size, dst, src, immediate)   { if (size == 128) { CDK_vsli_q(32,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsli_d(32,(A64_X) dst, (A64_X) src, immediate); } }
#define CDK_vsli_64(size, dst, src, immediate)   { if (size == 128) { CDK_vsli_q(64,(A64_V) dst, (A64_V) src, immediate); }  else if (size == 64) { CDK_vsli_d(64,(A64_X) dst, (A64_X) src, immediate); } }

static inline void CDK_vsri_q(INT size, A64_V dst, A64_V src, int immediate)
{
...
static inline void CDK_vsri_d(INT size, A64_X dst, A64_X src, int immediate)
{
  CDK_ASSERT(immediate >= 1);
  CDK_ASSERT(immediate <= size);
  switch (size)
...
static void inline CDK_vswp_q (A64_V q0, A64_V q1)
{
  A64_S tmp;
...
static void inline CDK_vswp_d (A64_S *d0, A64_S *d1)
{
  A64_S tmp;
...
#endif
#else
#define CDK_vand(size, dst,  src1, src2)   __CDK_vand((INT)size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vbic(size, dst,  src1, src2)   __CDK_vbic((INT)size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_veor(size, dst,  src1, src2)   __CDK_veor((INT)size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vorr(size, dst,  src1, src2)   __CDK_vorr((INT)size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vorn(size, dst,  src1, src2)   __CDK_vorn((INT)size, (A64_S) dst, (A64_S) src1, (A64_S) src2);

static inline void __CDK_vand(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
    dst[i] = src1[i] & src2[i];
...
static inline void __CDK_vbic(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
    dst[i] = src1[i] & (~src2[i]);
...
static inline void __CDK_veor(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
    dst[i] = src1[i] ^ src2[i];
...
static inline void __CDK_vorr(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
    dst[i] = src1[i] | src2[i];
...
static inline void __CDK_vorn(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
    dst[i] = src1[i] | (~src2[i]);
...
#endif
#else
#define CDK_vmax_s32(size, dst,  src1, src2)   __CDK_vmax_s32(size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vmax_s16(size, dst,  src1, src2)   __CDK_vmax_s16(size, (A64_H) dst, (A64_H) src1, (A64_H) src2);
#define CDK_vmin_s32(size, dst,  src1, src2)   __CDK_vmin_s32(size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vmin_s16(size, dst,  src1, src2)   __CDK_vmin_s16(size, (A64_H) dst, (A64_H) src1, (A64_H) src2);
#define CDK_vpmax_s32(size, dst,  src1, src2)  __CDK_vpmax_s32(size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vpmax_s16(size, dst,  src1, src2)  __CDK_vpmax_s16(size, (A64_H) dst, (A64_H) src1, (A64_H) src2);
#define CDK_vpmin_s32(size, dst,  src1, src2)  __CDK_vpmin_s32(size, (A64_S) dst, (A64_S) src1, (A64_S) src2);
#define CDK_vpmin_s16(size, dst,  src1, src2)  __CDK_vpmin_s16(size, (A64_H) dst, (A64_H) src1, (A64_H) src2);

static inline void __CDK_vmax_s32(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
...
static inline void __CDK_vmax_s16(INT size, A64_H *dst, A64_H *src1, A64_H *src2)
{
  for (int i = 0; i < (size>>4); i++)
  {
    dst[i] = fMax(src1[i], src2[i]);
...
static inline void __CDK_vmin_s32(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < (size>>5); i++)
  {
...
static inline void __CDK_vmin_s16(INT size, A64_H *dst, A64_H *src1, A64_H *src2)
{
  for (int i = 0; i < (size>>4); i++)
  {
  dst[i] = fMin(src1[i], src2[i]);
...
static inline void __CDK_vpmax_s32(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  A64_S tmp[4];
  int i;
  for (i = 0; i < (size>>6); i++)
...
static inline void __CDK_vpmin_s32(INT size, A64_S *dst, A64_S *src1, A64_S *src2)
{
  A64_S tmp[4];
  int i;
  for (i = 0; i < (size>>6); i++)
...
static inline void __CDK_vpmax_s16(INT size, A64_H *dst, A64_H *src1, A64_H *src2)
{
  A64_H tmp[8];
  int i;
  for (i = 0; i < (size>>5); i++)
...
static inline void __CDK_vpmin_s16(INT size, A64_H *dst, A64_H *src1, A64_H *src2)
{
  A64_H tmp[8];
  int i;
  for (i = 0; i < (size>>5); i++)
...
static inline void __CDK_vadd_s64_q(A64_V dst, A64_V src1, A64_V src2)
{
  INT64 *Dst  = (INT64 *) dst;
...
static inline void __CDK_vadd_s64_d(A64_X dst, A64_X src1, A64_X src2)
{
  INT64 *Dst  = (INT64 *) dst;
  INT64 *Src1 = (INT64 *) src1;
  INT64 *Src2 = (INT64 *) src2;
...
static inline void __CDK_vadd_s32_q(A64_V dst, A64_V src1, A64_V src2)
{
  A64_S *Dst  = (A64_S *) dst;
  A64_S *Src1 = (A64_S *) src1;
  A64_S *Src2 = (A64_S *) src2;
...
static inline void __CDK_vadd_s32_d(A64_X dst, A64_X src1, A64_X src2)
{
  A64_S *Dst  = (A64_S*) dst;
  A64_S *Src1 = (A64_S*) src1;
  A64_S *Src2 = (A64_S*) src2;
...
static inline void __CDK_vsub_s32_q(A64_V dst, A64_V src1, A64_V src2)
{
  for (int i = 0; i < 4; i++)
  {
    CDK_check_s32_overflow((INT64) src1[i] - (INT64) src2[i]);
...
static inline void __CDK_vsub_s32_d(A64_S *dst, A64_S *src1, A64_S *src2)
{
  for (int i = 0; i < 2; i++)
  {
    CDK_check_s32_overflow((INT64) src1[i] - (INT64) src2[i]);
...
static inline void __CDK_vsub_s64_q(A64_V dst, A64_V src1, A64_V src2)
{
  INT64 *Dst  = (INT64 *) dst;
  INT64 *Src1 = (INT64 *) src1;
  INT64 *Src2 = (INT64 *) src2;
...
static inline void __CDK_vsub_s64_d(A64_X dst, A64_X src1, A64_X src2)
{
  INT64 *Dst  = (INT64 *) dst;
  INT64 *Src1 = (INT64 *) src1;
  INT64 *Src2 = (INT64 *) src2;
...
static inline void __CDK_vpadd(INT size, A64_X dst, A64_X src1, A64_X src2)
{
  switch (size)
  {
    case 8:
...
#endif
#else
#define CDK_vshr_s32_q_imm(dst, src, immediate)     __CDK_vshr_s32_q_imm((A64_V)dst,(A64_V)src, immediate);
#define CDK_vshr_s32_d_imm(dst, src, immediate)     __CDK_vshr_s32_d_imm((A64_X)dst,(A64_X)src, immediate);
#define CDK_vshr_s16_q_imm(dst, src, immediate)     __CDK_vshr_s16_q_imm((A64_V)dst,(A64_V)src, immediate);
#define CDK_vshr_s16_d_imm(dst, src, immediate)     __CDK_vshr_s16_d_imm((A64_X)dst,(A64_X)src, immediate);
#define CDK_vqshrn_s64_imm(dst, src, immediate)     __CDK_vqshrn_imm(64,(A64_X)dst,(A64_V)src, immediate);
#define CDK_vqshrn_s32_imm(dst, src, immediate)     __CDK_vqshrn_imm(32,(A64_X)dst,(A64_V)src, immediate);
#define CDK_vqshrn_s16_imm(dst, src, immediate)     __CDK_vqshrn_imm(16,(A64_X)dst,(A64_V)src, immediate);

static inline void __CDK_vshr_s32_d_imm(A64_X dst, A64_X src, INT immediate)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  CDK_ASSERT(immediate >= 0);
...
static inline void __CDK_vshr_s32_q_imm(A64_V dst, A64_V src, INT immediate)
{
  A64_S *Dst = (A64_S *) dst;
  A64_S *Src = (A64_S *) src;
  CDK_ASSERT(immediate >= 0);
...
static inline void __CDK_vshr_s16_d_imm(A64_X dst, A64_X src, INT immediate)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  CDK_ASSERT(immediate >= 0);
...
static inline void __CDK_vshr_s16_q_imm(A64_V dst, A64_V src, INT immediate)
{
  A64_H *Dst = (A64_H *) dst;
  A64_H *Src = (A64_H *) src;
  CDK_ASSERT(immediate >= 0);
...
static A64_S CDK_saturate_shr_narrow_s64(INT64 val, INT immediate)
{
  val >>= immediate;
  if (val)
  {
...
static A64_H CDK_saturate_shr_narrow_s32(A64_S val, INT immediate)
{
  val >>= immediate;
  if (val)
  {
...
static SCHAR CDK_saturate_shr_narrow_s16(A64_H val, INT immediate)
{
  val >>= immediate;
  if (val)
  {
...
static inline void __CDK_vqshrn_imm(INT size, A64_X dst, A64_V src, INT immediate)
{
  CDK_ASSERT(immediate >= 0);
  CDK_ASSERT(immediate < size);
  switch (size)
...
static inline void __CDK_vsra_s32_d_imm(A64_S *dst, A64_S *src, int immediate)
{
  CDK_ASSERT(immediate >= 0);
  CDK_ASSERT(immediate < 32);
...
static inline void __CDK_vsra_s32_q_imm(A64_V dst, A64_V src, int immediate)
{
  CDK_ASSERT(immediate >= 0);
  CDK_ASSERT(immediate < 32);
  dst[0] += src[0]>>immediate;
...
static inline void __CDK_vshrn_imm(INT size, A64_X Dd, A64_V Qm, INT immediate)
{
  CDK_ASSERT(immediate >= 0);
  CDK_ASSERT(immediate < size);
...
static inline void __CDK_vshl_s32_d_imm(A64_S *dst, A64_S *src, INT immediate)
{
  for (int i = 0; i < 2; i++)
  {
    dst[i] = src[i]<<immediate;
...
static inline void __CDK_vshl_s32_q_imm(A64_S *dst, A64_S *src, INT immediate)
{
  for (int i = 0; i < 4; i++)
  {
    dst[i] = src[i]<<immediate;
...
static inline void __CDK_vshl_s16_d_imm(A64_H *dst, A64_H *src, INT immediate)
{
  for (int i = 0; i < 4; i++)
  {
    dst[i] = src[i]<<immediate;
...
static inline void __CDK_vshl_s16_q_imm(A64_V dst, A64_V src, INT immediate)
{
  for (int i = 0; i < 8; i++)
  {
    dst[i] = src[i]<<immediate;
...
{
  CDK_ASSERT((width == 8) || (width == 16) || (width == 32));  /* width of source vector elements to widen */
  CDK_ASSERT(immediate >= 0);
...
static inline void __CDK_vshl_s32_d(A64_X dst, A64_X src1, A64_X src2 )
{
  A64_S *Dst  = (A64_S *) dst;
  A64_S *Src1 = (A64_S *) src1;
  A64_S *Src2 = (A64_S *) src2;
...
static inline void __CDK_vshl_s32_q(A64_V dst, A64_V src1, A64_V src2)
{
  A64_S *Dst  = (A64_S *) dst;
  A64_S *Src1 = (A64_S *) src1;
  A64_S *Src2 = (A64_S *) src2;
...
static inline void __CDK_vshl_s16_d(A64_X dst, A64_X src1, A64_X src2)
{
  A64_H *Dst  = (A64_H *) dst;
  A64_H *Src1 = (A64_H *) src1;
  A64_H *Src2 = (A64_H *) src2;
...
static inline void __CDK_vshl_s16_q(A64_V dst, A64_V src1, A64_V src2)
{
  A64_H *Dst  = (A64_H *) dst;
  A64_H *Src1 = (A64_H *) src1;
  A64_H *Src2 = (A64_H *) src2;
...
{
  CDK_ASSERT ((width == 8) || (width == 16) || (width == 32));
  CDK_ASSERT((size == 64) || (size == 128));
  INT i, num = size / 64;
  switch (size)
  {
...
{
  CDK_ASSERT((width == 32) || (width == 16));
  CDK_ASSERT((size == 128) || (size  == 64) || (size == width));
  INT i, num = size / width;
  switch (width)
  {
    case 32:
...
#ifdef __ARM_AARCH64_NEON__
#if defined(__CC_ARM)
#define CDK_mov_Xt_imm(dst, imm)    MOV dst, CDK_TEXT(hash) imm
#define CDK_mov_Wt_imm(dst, imm)    MOV dst, CDK_TEXT(hash) imm
#else
#define __CDK_mov_Xt_imm(dst, imm)    "MOV " #dst ", # " #imm "\n\t"
#define __CDK_mov_Wt_imm(dst, imm)    "MOV " #dst ", # " #imm "\n\t"
// GNUC does not allow const expressions instead of constants, we need one layer inbetween
#define CDK_mov_Xt_imm(dst,imm)       __CDK_mov_Xt_imm(dst,imm)
#define CDK_mov_Wt_imm(dst,imm)       __CDK_mov_Wt_imm(dst,imm)
#endif
#else
#define CDK_mov_Xt_imm(dst, imm)    dst = imm;
#define CDK_mov_Wt_imm(dst, imm)    dst = imm;
#endif
...
#endif
#else
#define A64_asr_Xt_imm(Xd, Xn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 63)); Xd = (INT64) Xn >> uimm; }
#define A64_lsl_Xt_imm(Xd, Xn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 63)); Xd = (INT64) Xn << uimm; }
#define A64_lsr_Xt_imm(Xd, Xn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 63)); Xd = (UINT64) Xn >> uimm; }   
#define A64_ror_Xt_imm(Xd, Xn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 63)); Xd = ((UINT64) Xn >> uimm) | ((UINT64) Xn << ((64 - uimm) & 0x3F)); }
#define A64_asr_Wt_imm(Wd, Wn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 31)); Wd = (INT) Wn >> uimm; }
#define A64_lsl_Wt_imm(Wd, Wn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 31)); Wd = (INT) Wn << uimm; }
#define A64_lsr_Wt_imm(Wd, Wn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 31)); Wd = (UINT) Wn >> uimm; }
#define A64_ror_Wt_imm(Wd, Wn, uimm)    {  CDK_ASSERT((uimm >= 0) && (uimm <= 31)); Wd = ((UINT) Xn >> uimm) | ((UINT) Xn << ((32 - uimm) & 0x1F)); }
...
#define A64_adds_Xt_asr_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  Xd = ARMv8_adds_Xt((INT64)Xn, (INT64)Xm >> uimm);  }
/* Example: Add shifted offset to pointer: ptr = buffer + offset;  uimm-scale must be gretaer/equal zero */
#define A64_add_Xt_asr_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
                                                       Xd = (INT64) Xn + ((INT64) Xm >> (uimm));  }
#define A64_add_Xt_lsl_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
                                                       Xd = (INT64) Xn + (INT64) ((INT64) Xm << (uimm));  }
#define A64_add_Xt_lsr_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
...
#define A64_sub_Xt_asr_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
                                                       Xd = (INT64)Xn - ((INT64)Xm >> (uimm));  }
#define A64_sub_Xt_lsl_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
                                                       Xd = (INT64)Xn - ((INT64)Xm << (uimm));  }
#define A64_sub_Xt_lsr_imm(Xd, Xn, Xm, uimm)  { CDK_ASSERT((uimm >= 0) && (uimm <= 63));  \
                                                       CDK_ASSERT((uimm) >= 0);            \
                                                       Xd = (INT64)Xn - (INT64)((UINT64) Xm >> (uimm));  }
#endif
...
extern INT64 * __XZR;
    ...
    __CDK_coreflags_PL = (result>=0) ? 1 : 0;
    __CDK_coreflags_LE = (result<=0) ? 1 : 0;
    __CDK_coreflags_GT = (result> 0) ? 1 : 0;
    __CDK_coreflags_MI = (result< 0) ? 1 : 0;
    __CDK_coreflags_NE = result ? 1 : 0;
    __CDK_coreflags_EQ = result ? 0 : 1;
}
...
//                                                      => ADD r0, r1, r3, LSL #3
//  indexing a pointer:  r0 = (A64_S *) r1 + (r2<<3) => CDK_add_op_lsl(r0, r1, r2, 5, 2)
...
#define A64_subs(dst, src1, src2)          { dst = src1 - src2; \
                                             ...
                                             __CDK_coreflags_NE = dst ? 1 : 0; \
                                             __CDK_coreflags_EQ = dst ? 0 : 1; }
#define A64_sub_Xt_imm(dst, src, immediate)   { dst = (INT64) src - (INT64)(immediate); }
...
#define A64_sub_Wt(dst, src1, src2)           { dst = (INT64) ((INT) src1 - (INT) src2) & ((INT64) 0x00000000FFFFFFFF); }
...
#endif
#else
#define A64_cmp_Xt_imm(src, immediate)  {__CDK_coreflags_EQ = (INT64(src) == (INT64)(immediate)) ? 1 : 0; \
                                         __CDK_coreflags_NE = (INT64(src) != (INT64)(immediate)) ? 1 : 0; \
                                         __CDK_coreflags_GE = (INT64(src) >= (INT64)(immediate)) ? 1 : 0; \
                                         __CDK_coreflags_LT = (INT64(src) <  (INT64)(immediate)) ? 1 : 0; \
                                         __CDK_coreflags_GT = (INT64(src) >  (INT64)(immediate)) ? 1 : 0; \
                                         __CDK_coreflags_LE = (INT64(src) <= (INT64)(immediate)) ? 1 : 0;  }
#define A64_cmp_Wt_imm(src, immediate)  {__CDK_coreflags_EQ = (INT(src) == (INT)(immediate)) ? 1 : 0; \
...
#define A64_cmp_Xt(src1, src2)          {__CDK_coreflags_EQ = (INT64(src1) == (INT64)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_NE = (INT64(src1) != (INT64)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_GE = (INT64(src1) >= (INT64)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_LT = (INT64(src1) <  (INT64)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_GT = (INT64(src1) >  (INT64)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_LE = (INT64(src1) <= (INT64)(src2)) ? 1 : 0;  }

#define A64_cmp_Wt(src1, src2)          {__CDK_coreflags_EQ = (INT(src1) == (INT)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_NE = (INT(src1) != (INT)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_GE = (INT(src1) >= (INT)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_LT = (INT(src1) <  (INT)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_GT = (INT(src1) >  (INT)(src2)) ? 1 : 0; \
                                         __CDK_coreflags_LE = (INT(src1) <= (INT)(src2)) ? 1 : 0;  }

#define A64_cmp_Xt_X_ASR(src1, src2, src3)  {__CDK_coreflags_EQ = (INT64(src1) == ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0; \
                                             __CDK_coreflags_NE = (INT64(src1) != ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0; \
                                             __CDK_coreflags_GE = (INT64(src1) >= ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0; \
                                             __CDK_coreflags_LT = (INT64(src1) <  ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0; \
                                             __CDK_coreflags_GT = (INT64(src1) >  ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0; \
                                             __CDK_coreflags_LE = (INT64(src1) <= ((INT64)(src2) >> (INT64)(src3))) ? 1 : 0;  }
#endif
#ifdef __ARM_AARCH64_NEON__
#if defined(__CC_ARM)
...
// For parameter 'cond' please refer to CDK_aarch64_neon_regs.h
#ifdef __ARM_AARCH64_NEON__
#if defined(__CC_ARM)
#else
#define A64_branch(cond,name)        "B" #cond " " #name " \n\t"
#endif
#else
#define A64_branch(cond,name)        if (__CDK_coreflags_ ## cond) goto name;
#endif
...
#if defined (__ARM_AARCH64_NEON__) && defined (__CC_ARM)
...
#elif defined (__ARM_AARCH64_NEON__) && defined (__GNUC__)
...
#define A64_ASM_ROUTINE_RETURN(proc_type)  }
#elif defined (__ARM_AARCH64_NEON__) && defined (__GNUC__)
#define A64_ASM_ROUTINE_START(proc_type, proc_name, proc_args)   \
...
#endif  /* CDK_AARCH64_NEON_FUNCS_H */
